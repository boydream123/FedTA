...
def initialize_exp(params, *args, dump_params=True):
    ...
    if not os.path.isdir(params.dump_path):
        ...
        # 存放中间模型
        os.mkdir(os.path.join(params.dump_path, 'checkpoints'))
    ...
    training_stats = PD_Stats(
        os.path.join(params.dump_path, "STATS" + os.path.basename(params.pretrained) + ".pkl"), args
    )
...
def restart_from_checkpoint(ckp_paths, run_variables=None, **kwargs):
    ...
    # open checkpoint file  默认为分布式的，注释改为单机器加载
